...
let sign () =
  ...
  Alcotest.(check string)
    "same string" expected (Ed25519.sign sk msg)
...
let verify () =
  ...
  in
  Alcotest.(check bool)
    "same bool" expected (Ed25519.verify pk msg sign)

let secret_to_public () =
  let expected = "b7a3c12dc0c8c748ab07525b701122b88bd78f600c76342d27f25e5f92444cde"
  in
  let sk = "1498b5467a63dffa2dc9d9e069caf075d16fc33fdd4c3b01bfadae6433767d93" in
  Alcotest.(check string)
    "same string" expected (Ed25519.secret_to_public sk)
...
let tests =
  ...
  ( "Ed25519",
    [
      ...
      test_case "Verify if a public key + message + signature is valid" `Quick verify;
